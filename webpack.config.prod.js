...
export default {
    ...
    module: {
        rules: [
            ...
            {test: /(\.css|\.scss|\.sass)$/, loader: ExtractTextPlugin.extract('css-loader?sourceMap&modules&importLoaders=2&localIdentName=[hash:base64:5]!postcss-loader!sass-loader?sourceMap')}
        ]
    }
};
